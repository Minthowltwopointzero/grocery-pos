...
<head>
    ...
    <style>
        ...
        .sidebar { background:#1e293b !important; width:260px; }
        ...
        .hamburger-btn { border:none; background:transparent; font-size:1.4rem; color:#1e293b; padding:.25rem .5rem; border-radius:.4rem; }
