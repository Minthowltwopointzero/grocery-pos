...
<div class="card p-3">
    <form method="GET" class="row g-2 mb-3">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('sales.my') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
        </div>
    </form>

    <div class="table-responsive">
    <table class="table table-hover align-middle">
        <thead><tr><th>Invoice</th><th>Date</th><th>Customer</th><th>Type</th><th>Total</th><th>Status</th><th></th></tr></thead>
        <tbody>
